    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <h2 class="my-4">Registrar Gerencia</h2>
        ...
        <div class="col-lg-9">
            ...
            <div class="my-5">
              ...
              <h4 class="my-1" ">Registrar Gerencia</h4>

          		<form action="../controlador/registrar_gerencia.php" method="post" accept-charset="utf-8">
                <table>
                  <tbody>
                    <tr>
                      <td>
                      ...
                      <td>
                        <input type="text" name="descripcion_gerencia" placeholder="Descripción" required>
                      </td>
                    </tr>
                  </tbody>
                </table>
                <button type="submit" class="btn btn-primary my-4">Registrar Gerencia</button>
