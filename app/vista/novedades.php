              ...
              <div class="table">
                <table id="myTable">
                  ...
                  <tbody>
                    ...
                    while ($row = pg_fetch_array($novedades))
                    {
                    ?>
                    <tr>
                      <td><a href="../controlador/datos_novedades.php?id_novedades=<?php echo $row['id'];?>">Modificar</a></td>
                      <?php
                        if ($row['estatus_dato'] == 0)
                        {
                      ?>
                          <td><a onclick="Desactivar()" href="../controlador/desactivar_novedades.php?id_novedades=<?php echo $row['id'];?>">Desactivar</a></td>
                      <?php
                        }
                        else
                        {
                      ?>
                          <td><a onclick="Activar()" href="../controlador/activar_novedades.php?id_novedades=<?php echo $row['id'];?>">Activar</a></td>
                      <?php
                        }
                      ?>
                ...
                <a href="../vista/registrar_novedades.php" class="btn btn-primary">Nueva Novedad</a>
            </div>
          </div>
        <!--/.tab-content -->
